const en: { [key: string]: string } = {
  ...
  DennisMap: "Dennis Map",
  aboutUs: "About Us",
  contactUs: "Contact Us",
  saleInDennis: "Sale In Dennis",
  ...
  register: "Register",
  copyRight:
    "© 2026 Dennis. All rights reserved - Designed and Developed with ",
  sort: "Sort based on: ",
  all: "All",
  ...
  phoneRegion: "Country code",
  enterNationalPhoneNumber: "Number (without country code)",
